...
#define A_ENCODER 		PORTNUM2PIN(PA, 1)
#define B_ENCODER 		PORTNUM2PIN(PB, 23)

#define ENABLE_TARJETA_MAGNETICA 	PORTNUM2PIN(PB, 10) //amarillo
#define DATA_TARJETA 				PORTNUM2PIN(PC, 4) //azul
#define CLOCK_TARJETA_MAGNETICA 	PORTNUM2PIN(PB, 3) //verde
